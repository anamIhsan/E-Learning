        ...
        <div class="flex justify-between items-center">
           <div class="menu-left">
            ...
            <div class="menu-center flex flex-row -ml-80">
                <div class="search-dropdown-button relative">
                    ...
                    <div class="search-dropdown absolute top-full left-0 bg-white shadow-md">
                        <ul class="text-left text-gray-600  bg-white border">
                            <a href="{{ route('categories') }}"><li class="pl-3 pr-24 py-2 hover:bg-green-400 hover:text-white transition duration-300">PROGRAMING</li></a>
                            <a href="{{ route('categories') }}"><li class="pl-3 pr-24 py-2 hover:bg-green-400 hover:text-white transition duration-300">DESIGN</li></a>
                            <a href="{{ route('categories') }}"><li class="pl-3 pr-24 py-2 hover:bg-green-400 hover:text-white transition duration-300">PHOTOGRAPHY</li></a>
                            <a href="{{ route('categories') }}"><li class="pl-3 pr-24 py-2 hover:bg-green-400 hover:text-white transition duration-300">PROGRAMING</li></a>
                        </ul>
                    </div>
                </div>
                ...
                <a href="{{ route('all-category-before') }}">

...
@section('content')
    ...
    <div class="categories py-14">
        <div class="container mx-auto">
            <div class="flex flex-col" data-aos="fade-down" data-aos-delay="100" data-aos-duration="1000">
            ...
            <div class="grid grid-cols-4 gap-7">
                @foreach ($course as $courses)
                    <div class="col-span-1" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <div class="">
                            <img src="/profile/{{ $courses->thumbnail }}" class="w-full">
                        </div>
                        <div class="px-3 py-5 space-y-2 shadow-xl">
                            ...
                            <p class="text-gray-500 text-sm">
                                Mr. {{$courses->user->name}}
                            </p>
                            <a href="{{ route('class', $courses->id) }}">
                                <button 

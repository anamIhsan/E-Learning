      ...
      <div class="col-md-8">
        <div class="d-flex flex-column align-items-start">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{ route('admin-dashboard-chapter-update', $chapters->id) }}" enctype="multipart/form-data" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                  <div class="col-md-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                    <div class="form-group">
                      ...
                      <input type="hidden" value="{{ $chapters->course->id }}" name="courses_id">
                      <input 
                        type="text" 
                        class="form-control"
                        name="title"
